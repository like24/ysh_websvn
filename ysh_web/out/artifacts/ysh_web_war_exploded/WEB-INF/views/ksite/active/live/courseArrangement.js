        ...
        submitBtn: function () { //提交订单
            if (this.name == "") {
                ...
                $.ajax({
                    type: "get",
                    dataType: "json",
                    url: JspElement.ctx+"/w/logger/1000/"+_this.money1+"/"+JspElement.uid+".html?o="+JspElement.ordernumber+"&usephone="+_this.phone + "&srowid="+userID+"&courseName=" + _this.detaills.name,
