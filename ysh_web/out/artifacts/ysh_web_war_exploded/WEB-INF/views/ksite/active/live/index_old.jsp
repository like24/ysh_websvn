...
<body>
	<div id="app">
		...
		<header class="video-box relative" id="videoBox">
			<!--视频源-->
			<video class="video absolute" controls="controls" webkit-playsinline="true" x-webkit-airplay="true"  playsinline="true"x5-video-player-type="h5"x5-video-player-fullscreen="true" id="video">
		...
		<section class="teach-wrapper absolute" id="mainBox">
			<ul>
				...
				<%--<!-- 老师或管理员的普通消息 -->--%>
					...
					<%--</div>--%>
				<%--<li>--%>
				<%--&lt;%&ndash;&lt;%&ndash; 	<!--老师和管理员单独发送的文字 start-->&ndash;%&gt;--%>
				<%--<li class="ls-zcr item">--%>
					...
					<%--</div>--%>
				<%--</li>--%>
				<%--&lt;%&ndash;<!--老师和管理员单独发送的文字 end-->&ndash;%&gt;--%>
				<%--&lt;%&ndash;<!--老师和管理员单独发的语音 start-->&ndash;%&gt;--%>
				<%--<li class="ls-zcr flex item">--%>
					<%--<!--头像-->--%>
					<%--<div class="head-box">--%>
						<%--<img src="${ctx}/images/a.png" alt="" class="head" />--%>
	...
	<script>
        ...
        wx.ready(function(Api){
            ...
            var title1 = "瑜伽清洁老司机带你玩转瑜伽六大清洁法，现场直击真实震撼的清洁体验",
                img1 = vw.detaills.logo,
                desc1 = vw.detaills.remark;
