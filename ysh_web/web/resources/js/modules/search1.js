...
var vw = new Vue({
    ...
    methods: {
        ...
        setLocalStorage: function() {
            ...
            window.sessionStorage.setItem(searchPage + "zhibolist", JSON.stringify(this.teacherlist));
            ...
            window.sessionStorage.setItem(searchPage + "zhibolist3", JSON.stringify(this.teacherlist3));
            window.sessionStorage.setItem(searchPage + "zh", JSON.stringify(this.teacherlist3));
            ...
            window.sessionStorage.setItem(searchPage + "zhibo", this.ask);
        ...
        upData: function(res) {
            ...
            if(res.zhibolist !== undefined) {
                _this.zhibolist = res.zhibolist;
                var len = res.zhibolist.length;
                if(len < 2) {
                    _this.zhibolist = [res.zhibolist[0]];
                } else if(len < 3) {
                    _this.zhibolist3 = [res.zhibolist[0], res.zhibolist[1]];
                } else {
                    _this.zhibolist3 = [res.zhibolist[0], res.zhibolist[1], res.zhibolist[2]];
                }
            } else {
                _this.teach = 0;
            }
            if(_this.courselist.length == 0 && _this.asklist.length == 0 && _this.teacherlist.length == 0&& _this.zhibolist.length == 0) {
                this.noContent = true;
                _this.boxShow = false;
            } else {
        ...
        changeNav: function($event) { //切换顶部导航
            ...
            $("#borderB").removeClass("left0 left1 left2 left3 left4");
            $("#borderB").addClass("left" + this.inx); //显示下边框的位置
            var arr = [1, this.course, this.ask, this.teach,this.zhibo];
            //显示对应内容
    ...
    created: function() {
        ...
        if(sessionStorage.getItem(searchPage + "history")) {
            ...
            this.zhibolist = JSON.parse(window.sessionStorage.getItem(searchPage + "teacherlist"));
            ...
            this.zhibolist3 = JSON.parse(window.sessionStorage.getItem(searchPage + "teacherlist3"));
            ...
            this.zhibo =~~window.sessionStorage.getItem(searchPage + "zhibo");
