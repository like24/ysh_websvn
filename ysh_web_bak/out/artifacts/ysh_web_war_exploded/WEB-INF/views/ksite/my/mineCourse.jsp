					...
					<div class="hot-recommend bg-fff m30 m-b hot-recommend1" v-show="tab">
						<div>
							<dl class="item" v-for="item in zhibo">
								<a href="http://weixin.keepyoga.com/w/faq/course.html?p=580" class="flex"><dt class="relative"><img data-src="http://wimg.keepyoga.com/20170330113044198_463.jpg" src="item.logo" alt="系统学习经络轮棒瑜伽"> </dt>
									<dd class="ohidden relative">
										<h5 class="name ellipsis">{{item.cname}}</h5> <span class="type block ellipsis2">共{{item.ji}}集</span> 
										<time>{{item.starttime}} 开课</time>
										<span class="time block">{{item.buycount}}人报名</span>
					...
					<div class="hot-recommend bg-fff m30 m-b" v-show="tab1">
						<div>
							<dl class="item" v-for="item in lubo">
								<a href="http://weixin.keepyoga.com/w/faq/course.html?p=529" class="flex"><dt class="relative"><img data-src="http://wimg.keepyoga.com/20170217152846637_183.jpeg" :src="item.icon" alt="“一年之计在于春”之瑜伽馆春季招聘培训课（上下）"> <i class="icon  absolute icon-audio"></i></dt>
									<dd class="ohidden relative">
