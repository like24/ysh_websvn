 ...
 * Generated at: 2017-05-08 11:59:43 UTC
...
public final class livelist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<!--   直播课程   -->\n");
      out.write("\t\t\t\t\t<div class=\"hot-recommend bg-fff m30 m-b\" v-if=\"items.length\">\n");
      out.write("\t\t\t\t\t\t\t<dl class=\"item\" v-for=\"item in items\">\n");
      out.write("\t\t\t\t\t\t\t\t<a :href=\"'");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/v2/live/detail/111.shtml?id='+item.id\" class=\"flex\"> <dt class=\"relative\">\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<h5 class=\"name ellipsis\"><p class=\"topic  \" :class=\"item.status?'zb-tit':'zb-tit'\">\n");
      out.write("\t            \t\t\t\t\t\t<small></small>\n");
      out.write("\t            \t\t\t\t\t</p>\t{{ item.name }}</h5> \n");
      out.write("\t            \t\t\t\t\t<span class=\"type block ellipsis2\" style=\"margin-top: .4rem;\">{{ item.starttime.substr(5) }}开课</span>\n");
      ...
      out.write("\t\t<script>\n");
      out.write("\t\t\tvw.init(\"live/getList.json\");\n");
      out.write("\t\t\twx.config({\n");
  ...
  private boolean _jspx_meth_c_005fset_005f5(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/ksite/more/livelist.jsp(4,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f5.setVar("footclass");
      // /WEB-INF/views/ksite/more/livelist.jsp(4,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
