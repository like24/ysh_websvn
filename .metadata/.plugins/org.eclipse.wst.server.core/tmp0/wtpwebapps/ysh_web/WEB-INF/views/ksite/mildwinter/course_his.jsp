...
<html lang="en">
	...
	<head>
		...
		<style>
			<c:if test="${ocourse.ctype == 1}">.audio_style {
	...
	<body>
		...
		<div class="buyTipBox">
			...
			<div class="buyTip">
				...
				<p><img src="http://wimg.keepyoga.com/images/tlqicon.png" class="icon">该课程是收费课程，观看需购买
					<a href="${ctx}/w/faq/course.html?p=${ocourse.id}">本节课程</a>，或者
					<a href="${ctx}/w/faq/distributionq.html">2016瑜伽私教集训营</a>全部课程。若有疑问，请联系客服4000186161。</p>
		...
		<div class="wrapper">
			...
			<section class="mainBox <c:if test=" ${user.id !=c ourse.tid} ">main2</c:if> " id="mainBox">
